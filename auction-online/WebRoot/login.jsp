    ...
    <div class="login">
      <dl>
        ...
        <dd>
           ...
           <span style="color:red; font-size:16px; font-weight:bole ">${errorMsg}</span>
        </dd>
        <dd class="buttom">
           <input name="" type="submit" value="登 录" class="spbg buttombg f14 lf" />
           <input id="register" name="" type="button" value="注 册" class="spbg buttombg f14 lf"  onclick="location='register.jsp'"/>
