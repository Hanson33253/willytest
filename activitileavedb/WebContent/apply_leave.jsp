                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label>标题</label>
								<input type="text" class="form-control" id="title" name="content" placeholder="">
                            </div>

                            <div class="form-group">
                                <label for="col_name">天数</label>
                                <input type="text" class="form-control" id="money" name="days" placeholder="">
                            </div>
